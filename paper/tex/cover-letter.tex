...
Transmission to Corporate Balance Sheets: A Nine-Country Emerging-Market
...
nine emerging markets over 2010--2025. Vietnam and T\"{u}rkiye anchor the
...
within a year---and seven further countries (Brazil, Chile, Hungary, Israel,
Mexico, Poland, South Korea) extend the test across the full range of
tightening severity observed globally in the 2021--2025 cycle.

The contributions are of three kinds:

\begin{enumerate}
\item \textbf{A validated price measure, confirmed across nine countries.} A
...
peaks at 47.5\%. Pooling all nine countries, the change in this measure
correlates with policy tightening dose at $r=0.983$, and median interest
coverage falls in every single country. I use the two-country history to
...
long enough to test parallel trends, and that this null holds pooling all nine
