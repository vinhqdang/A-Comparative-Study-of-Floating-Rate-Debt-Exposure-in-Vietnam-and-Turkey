...
rather than observed, and test its predictions on harmonised panels of 693
Vietnamese and 585 Turkish listed non-financial firms over 2010--2025,
exploiting a contrast in dose: T\"{u}rkiye tightened from 9\% to 47.5\%, Vietnam
mildly and briefly. The price of debt proves recoverable. A simple implied
borrowing cost reproduces each central bank's policy path unprompted, yielding
pass-through of roughly 35\% while median interest coverage halves. Exposure
does not. Split-half reliabilities of $-0.219$ and $-0.080$ imply an attenuation
factor of zero, and T\"{u}rkiye's inflation-accounting restatement enters as an
exposure-by-post interaction that fixed effects cannot absorb. No exposure
gradient survives. The contractual object these designs require is absent from
