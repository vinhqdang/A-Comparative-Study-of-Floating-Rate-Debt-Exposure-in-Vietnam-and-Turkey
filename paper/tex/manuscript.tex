...
not. Split-half reliabilities of $-0.219$ and $-0.080$ in the two countries with
...
these diagnostics cannot pass, reported in Table~\ref{tab:split}.
...
During the preparation of this work the author used AI-assisted software
tools to support data collection and processing, statistical analysis, literature
search and verification, and drafting of the manuscript text. After using
